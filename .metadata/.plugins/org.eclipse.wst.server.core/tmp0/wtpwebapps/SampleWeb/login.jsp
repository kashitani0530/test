...
<link rel="styleaheet" href="./css/style.css">
<title>ログイン</title>
<script>
...
-->
	<table class="vertical-list-table">
		...
		<tr>
			...
			<td><s:password name="password" class="txt" plaeceholder="パスワード" autocomplete="off"/></td>
		</tr>
	</table>
	<div class="box">
		<s:if test="#session.savedLoginId==true">
...
<div class="submit_btn_box">
	<div id =".contents_btn_set">
		<s:form action="CreateUserAction">
			<s:submit value="新規ユーザー" class="submit_btn"/>
		</s:form>
	</div>
</div>
<div class="submit_btn_box">
