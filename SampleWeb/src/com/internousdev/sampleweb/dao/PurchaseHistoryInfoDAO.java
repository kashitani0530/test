	...
	public List<PurchaseHistoryInfoDTO> getPurchaseHistoryList(String loginId){
		...
		try{
			...
			while(resultSet.next()){
				...
				purchaseHistoryInfoDto.setProductNameKana(resultSet.getString("product_name_lana"));
				purchaseHistoryInfoDto.setProductDesciption(resultSet.getString("product_description"));
